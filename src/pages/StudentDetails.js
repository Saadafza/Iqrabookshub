...
function StudentDetails() {
    ...
    const handleDelete = () => {
        if (window.confirm("are you sure?") == true) {
            axios.delete("https://iqnodejs-git-main-saadafza.vercel.app/api/student-delete/" + id).then((res) => {
    ...
    useEffect(() => {
        axios.get("https://iqnodejs-git-main-saadafza.vercel.app/api/student/" + id).then((res) => {
            if (res.data.status == true) {
